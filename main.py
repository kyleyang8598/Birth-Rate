...
data = """Period,Mothers_Age,Age_specific_birth_rate
2005,Under 15,0.2
2005,15–19,27.2
2005,20–24,67.6
2005,25–29,104.9
...
df_pivot = df.pivot(index="Period", columns="Mothers_Age", values="Age_specific_birth_rate")
...
plt.title("Age-Specific Birth Rates Over Time", fontsize=14)
plt.xlabel("Year", fontsize=12)
plt.ylabel("Birth Rate (per 1,000 women)", fontsize=12)
plt.legend(title="Mother's Age Group")
plt.grid(True)
plt.tight_layout()
plt.show()
...
plt.figure(figsize=(10, 6))
plt.bar(df_2020["Mothers_Age"], df_2020["Age_specific_birth_rate"], color="skyblue")
plt.title("Age-Specific Birth Rates in 2020", fontsize=14)
